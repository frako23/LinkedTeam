...
from .models import db, User, Cliente, Comment, Response, Agencies, Tarea, Client_Activity, Courses, Company, Payment, Account_Information
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Agencies, db.session))
